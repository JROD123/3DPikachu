...
function init()
{
    ...
    renderer.setClearColor(0xffce00)
    ...
    var light3 = new THREE.SpotLight(0xffffff, 0.35);
    scene.add(light3);
    ...
    var Dirlight = new THREE.DirectionalLight(0xffffff, 0.22);
    scene.add(Dirlight);

    Dirlight.position.z=6;
    Dirlight.position.y=-6;


    var loader = new THREE.GLTFLoader();

    loader.load("pikachu.glb", handle_load);
